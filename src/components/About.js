    ...
    <section id="about" className="container">
      ...
      <div className="row align-items-start">
        ...
        <div className="col-md-8">
          ...
          <p>Ich möchte gerne eine neue Geschichte erzählen, anstatt an der alten festzuhalten. Doch was hat mich dazu gebracht? Es war mein Körper, der "Stopp" sagte. Inmitten von Angststörungen und Panikattacken bin ich der Intelligenz meines Körpers begegnet. Ich verstand nicht, was geschah, war verwundert und versuchte, mich aus der Situation herauszudenken, auf der Suche nach Wahrheiten und Dingen, die mir entgingen. Je mehr ich jedoch nachdachte, desto schlimmer wurde alles. Alles, was ich bis dahin wusste und gelesen hatte, war absolut nicht hilfreich. Ruhe und Frieden schien unerreichbar.</p>
...
<p>Ich habe begriffen, dass Angststörungen ein körperlicher Zustand sind, und das war für mich revolutionär. Deshalb reicht es nicht aus, nur kognitive Ansätze zu verfolgen. Wir müssen den Körper mitnehmen und in tiefen Kontakt mit ihm treten.</p>
          </div>
          <div className="bio-content">
            ...
            <ul>
              ...
              <li>2023-jetzt: Weiterbildung in Körperarbeit: Vagusnerv, Breathwork, Stimme, neurogenes Zittern und selbstgesteuertes Studium des Nervensystems basierend auf der Polyvagal-Theorie (Traumaheilung)</li>
